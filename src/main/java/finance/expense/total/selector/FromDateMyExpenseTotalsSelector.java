...
public class FromDateMyExpenseTotalsSelector implements ExpenseTotalsSelector {
    ...
    public FromDateMyExpenseTotalsSelector(ExpenseRepository expenseRepository,
                                           long botChatId,
                                           int botUserId,
                                           Date from) {
